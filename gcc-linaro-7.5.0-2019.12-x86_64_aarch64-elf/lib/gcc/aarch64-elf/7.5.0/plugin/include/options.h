...
enum opt_code
{
  ...
  OPT_mbig_endian = 1154,                    /* -mbig-endian */
  ...
  OPT_momit_leaf_frame_pointer = 1164,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1165,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1166,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1167,          /* -msign-return-address= */
  OPT_mstrict_align = 1168,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1169,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1170,                     /* -mtls-size= */
  OPT_mtune_ = 1171,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1172,             /* -mverbose-cost-dump */
  OPT_n = 1173,                              /* -n */
  OPT_no_canonical_prefixes = 1174,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1175,              /* -no-integrated-cpp */
  OPT_no_pie = 1176,                         /* -no-pie */
  OPT_nocpp = 1177,                          /* -nocpp */
  OPT_nodefaultlibs = 1178,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1179,                   /* -nostartfiles */
  OPT_nostdinc = 1180,                       /* -nostdinc */
  OPT_nostdinc__ = 1181,                     /* -nostdinc++ */
  OPT_nostdlib = 1182,                       /* -nostdlib */
  OPT_o = 1183,                              /* -o */
  OPT_p = 1184,                              /* -p */
  OPT_pass_exit_codes = 1185,                /* -pass-exit-codes */
  /* OPT_pedantic = 1186, */                 /* -pedantic */
  OPT_pedantic_errors = 1187,                /* -pedantic-errors */
  OPT_pg = 1188,                             /* -pg */
  OPT_pie = 1189,                            /* -pie */
  OPT_pipe = 1190,                           /* -pipe */
  OPT_print_file_name_ = 1191,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1192,         /* -print-libgcc-file-name */
  ...
  OPT_static_liblsan = 1217,                 /* -static-liblsan */
  OPT_static_libmpx = 1218,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1219,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1220,               /* -static-libstdc++ */
  OPT_static_libtsan = 1221,                 /* -static-libtsan */
  OPT_static_libubsan = 1222,                /* -static-libubsan */
  /* OPT_std_c__03 = 1223, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1224, */                /* -std=c++0x */
  OPT_std_c__11 = 1225,                      /* -std=c++11 */
  OPT_std_c__14 = 1226,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1227, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1228, */                /* -std=c++1y */
  OPT_std_c__1z = 1229,                      /* -std=c++1z */
  OPT_std_c__98 = 1230,                      /* -std=c++98 */
  OPT_std_c11 = 1231,                        /* -std=c11 */
  /* OPT_std_c1x = 1232, */                  /* -std=c1x */
  /* OPT_std_c89 = 1233, */                  /* -std=c89 */
  OPT_std_c90 = 1234,                        /* -std=c90 */
  OPT_std_c99 = 1235,                        /* -std=c99 */
  /* OPT_std_c9x = 1236, */                  /* -std=c9x */
  OPT_std_f2003 = 1237,                      /* -std=f2003 */
  OPT_std_f2008 = 1238,                      /* -std=f2008 */
  OPT_std_f2008ts = 1239,                    /* -std=f2008ts */
  OPT_std_f95 = 1240,                        /* -std=f95 */
  OPT_std_gnu = 1241,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1242, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1243, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1244,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1245,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1246, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1247, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1248,                    /* -std=gnu++1z */
